...
class AbsensiKaryawanTab(ctk.CTkFrame):
    def __init__(self, parent, colors, current_user, on_scan, on_load,
                 font="Segoe UI"):
    ...
    def build_header(self):
        ...
        self.id_entry = ctk.CTkEntry(
            controls, width=300, height=46, corner_radius=10,
            border_color=self.colors["border"], fg_color=self.colors["bg"],
            placeholder_text="Scan barcode ID Card di sini...", font=(self.font_name, 12),
        )
        self.id_entry.pack(side="left")
        self.id_entry.bind("<Return>", lambda _event: self.process_scan())
        self.status_label = ctk.CTkLabel(
            card, text="Scan pertama: masuk  •  Scan kedua: pulang",
        ...
        self.after(120, self.id_entry.focus_set)
    ...
    def process_scan(self):
        success, message = self.on_scan(self.employee_id())
